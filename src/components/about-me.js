...
export default function AboutMe() {
  return (
    <div className="lg:h-[88vh] flex flex-col wrap justify-center items-center mt-[12vh]">
        ...
        <div className="sm:relative mb-[30px] mt-[10px] md:mt-0 md:absolute md:top-40 md:left-35 flex flex-col p-5 md:p-8 w-[90vw] md:w-[30vw] md:bg-[#40593D]/70 bg-[#374a34]/70 rounded relative z-10">
